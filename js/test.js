...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'out/test.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_out/test.data');

      };
      Module['addRunDependency']('datafile_out/test.data');
   ...
   loadPackage({"files": [{"filename": "/essage.txt", "start": 0, "end": 16}], "remote_package_size": 16, "package_uuid": "88f690ae-d51c-4978-93af-28a5164f08e1"});
